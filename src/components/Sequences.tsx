        ...
        return (
            <tr className="text-xl">
                <td className="w-1/2 space-x-2 pl-4 text-white flex">
                    {finalSequenceArray.map((_val, key) => (
                        <span key={key} className="hover:text-cyber-blue hover:inner-border-2 inner-border-cyber-blue p-2 w-10 h-auto flex items-center justify-center">{finalSequenceArray[rowNum][key]}</span>
                    ))}
                </td>
                <td>
                    <ul>
